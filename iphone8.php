        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphone8\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone8\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone8\2.png" onclick="clickimg(this)">
                   
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphone8\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iPhone 8">
                    <h2>
                    IPhone 8 Gold 64GB with 8 Mega Pixel Camera
                    </h2>   
                    <div class="review">
                        <span>(4.6)</span>
                    ...
                    <div class="price-box">
                    <input type="hidden" name="Price" value="39,999">
                        <p class="price">&#8377;39,999.00</p>
                        <strike> &#8377;40,000.00</strike>
                    </div>

        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphonexr\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphonexr\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphonexr\2.png" onclick="clickimg(this)">
                   
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphonexr\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iPhone XR">
                    <h2>
                    Apple:iPhone-XR (128Gb) Color-Red
                    </h2>   
                    <div class="review">
                        <span>(4.7)</span>
                    ...
                    <div class="price-box">
                    <input type="hidden" name="Price" value="39,499">
                        <p class="price">&#8377;39,499.00</p>
                        <strike> &#8377;43,800.00</strike>
                    </div>

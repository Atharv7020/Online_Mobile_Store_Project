        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\Nord2T\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\Nord2T\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\Nord2T\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\Nord2T\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\Nord2T\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="OnePlus Nord 2T">

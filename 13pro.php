        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphone13pro\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone13pro\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone13pro\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone13pro\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphone13pro\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iPhone 13 Pro">
                    <h2>
                    ...
                    <div class="price-box">
                    <input type="hidden" name="Price" value="1,07,900">
                        <p class="price">&#8377;1,07,900.00</p>
                        <strike> &#8377;1,20,900.00</strike>
                    </div>

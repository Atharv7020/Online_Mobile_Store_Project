        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\tabs8\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\tabs8\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\tabs8\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\tabs8\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\tabs8\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Samsung Galaxy Tab s8">
                    <h2>
                    Samsung Galaxy Tab s8(128Gb)-Silver
                    </h2>   
                    <div class="review">
                        <span>(4.3)</span>
                    ...
                    <input type="hidden" name="Price" value="58,999">
                        <p class="price">&#8377;58,999.00</p>
                        <strike> &#8377;62,900.00</strike>
                    </div>

        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\taba8\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\taba8\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\taba8\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\taba8\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\taba8\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Samsung Galaxy Tab A8">
                    <h2>
                    Samsung Galaxy Tab A8(128GB)-Gray
                    </h2>   
                    <div class="review">
                        <span>(4.3)</span>
                    ...
                    <input type="hidden" name="Price" value="16,999">
                        <p class="price">&#8377;16,999.00</p>
                        <strike> &#8377;23,900.00</strike>
                    </div>

        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphone6\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone6\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone6\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone6\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphone6\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iphone 6">
                    <h2>
                    IPhone 6G Silver 64GB with 8 Mega Pixel Camera
                    </h2>   
                    <div class="review">
                        <span>(4.6)</span>

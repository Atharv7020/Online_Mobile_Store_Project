        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphone11\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone11\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone11\2.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone11\3.png" onclick="clickimg(this)">
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphone11\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iPhone 11">
                    <h2>
                    ...
                    <div class="price-box">
                    <input type="hidden" name="Price" value="41,499">
                        <p class="price">&#8377;41,999.00</p>
                        <strike> &#8377;50,900.00</strike>
                    </div>

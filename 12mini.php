        ...
        <div class="wrapper">
            <div class="product-box">
                ...
                <div class="small-images">
                    <img src="images\ProductImages\iphone12mini\main.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone12mini\1.png" onclick="clickimg(this)">
                    <img src="images\ProductImages\iphone12mini\2.png" onclick="clickimg(this)">
                    
                    
                </div>
                <div class="main-images">
                    <img src="images\ProductImages\iphone12mini\main.png" id="imagebox">
                </div>
            </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <input type="hidden" name="MobileName" value="Apple iPhone 12 Mini">
                    <h2>
                    ...
                    <div class="price-box">
                    <input type="hidden" name="Price" value="59,490">
                        <p class="price">&#8377;59,490.00</p>
